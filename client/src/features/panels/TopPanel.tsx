import { BookOpen, ChevronDown, ChevronUp, Clipboard, Command, CopyPlus, Download, Eye, FileUp, PanelTopClose, Redo2, Search, Share2, Undo2 } from "lucide-react";
...
export function TopPanel({ open, appearance, workflowName, nodes, canUndo, canRedo, onToggle, onAppearanceChange, onUndo, onRedo, onFocusNode, onWorkflowAction }: TopPanelProps) {
